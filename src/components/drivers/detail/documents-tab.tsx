...
import type { DriverDocumentWithUrl } from "@/lib/data/driver-documents";
import { computeDocumentStatus } from "@/lib/domain/document";
import { formatDate } from "@/lib/format-time";
import { DOCUMENT_STATUS_LABEL, DRIVER_DOCUMENT_TYPE_LABEL } from "@/lib/i18n/labels";
...
export function DriverDocumentsTab({ documents }: { documents: DriverDocumentWithUrl[] }) {
            ...
            return (
              <TableRow key={doc.id}>
                <TableCell className="font-medium">
                  {DRIVER_DOCUMENT_TYPE_LABEL[doc.document_type]}
                </TableCell>
